...
<div class="card submit_btn">
    <div class="card-body">
        {% block submit-row %}
            {% if show_save %}
                <button type="submit" name="_save" class="btn btn-sm btn-info">{% trans 'Save' %}</button>
            {% endif %}

            {% if show_save_as_new %}
                <button type="submit" name="_saveasnew" class="btn btn-sm btn-info">{% trans 'Save as new' %}</button>
            {% endif %}
            ...
            {% if show_save_and_continue %}
                <button type="submit" name="_continue" class="btn btn-sm btn-info">{% if can_change %}{% trans 'Save and continue editing' %}{% else %}{% trans 'Save and view' %}{% endif %}</button>
            {% endif %}
